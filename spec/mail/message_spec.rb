...
describe Mail::Message do
  ...
  describe "initialization" do
    ...
    it "should return a basic email" do
      ...
      expect(Mail::StringHelper.blank?(mail.date)).not_to be_truthy
      expect(Mail::StringHelper.blank?(mail.message_id)).not_to be_truthy
      ...
      expect(Mail::StringHelper.blank?(mail.subject)).to be_truthy
      expect(Mail::StringHelper.blank?(mail.body)).to be_truthy
    end
    ...
    it "should be able to pass an empty reply-to header" do
      ...
      expect(Mail::StringHelper.blank?(mail.in_reply_to)).to be_truthy
    end
    ...
    describe "YAML serialization" do
      ...
      it "should serialize the basic information to YAML" do
        ...
        expect(Mail::StringHelper.blank?(yaml_output['@delivery_method'])).not_to be_truthy
      end
  ...
  describe "error handling" do
    it "should collect up any of its fields' errors" do
      ...
      expect(Mail::StringHelper.blank?(mail.errors)).not_to be_truthy
