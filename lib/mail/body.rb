...
module Mail
  ...
  class Body
    ...
    def encoding=( val )
      @encoding = if val == "text" || StringHelper.blank?(val)
    ...
    def extract_parts
      ...
      parts.each_with_index { |(part, _), index| parts.delete_at(index) if index > 0 && StringHelper.blank?(part) }
