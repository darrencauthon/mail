...
#        add_encoding_to_body
    ...
    def has_content_transfer_encoding?
      header[:content_transfer_encoding] && StringHelper.blank?(header[:content_transfer_encoding].errors)
    end
    ...
    def add_part(part)
      if !body.multipart? && !StringHelper.blank?(self.body.decoded)
    ...
    def add_file(values)
      convert_to_multipart unless self.multipart? || StringHelper.blank?(self.body.decoded)
    ...
    def self.from_yaml(str)
      ...
      hash.each do |k,v|
        ...
        when k == 'delivery_handler'
          begin
            m.delivery_handler = Object.const_get(v) unless StringHelper.blank?(v)
          rescue NameError
          end
